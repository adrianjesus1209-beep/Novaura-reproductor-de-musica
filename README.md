...
## APK descargable (Última versión v1.0.3)

El instalador compilado está disponible directamente en las releases principales de GitHub:

- 🚀 [Descargar Novaura v1.0.3 APK (Última Versión)](https://github.com/adrianjesus1209-beep/Novaura-reproductor-de-musica/releases/latest)
- 📦 [Descarga Directa Novaura-v1.0.3.apk](https://github.com/adrianjesus1209-beep/Novaura-reproductor-de-musica/releases/download/v1.0.3/Novaura-v1.0.3.apk)

## Instalación

1. Descarga el archivo `apk/Novaura-v1.0.3.apk` (o descárgalo desde la página de releases).
